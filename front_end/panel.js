...
var panelControl = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    headerDiv.innerHTML = '<a href="https://skillenza.com/challenge/mishmash-hackathon-bangalore"><img src="../../images/vroom.svg" alt="Vroom" /></a>';
    ...
    header.innerHTML = '<b>Vehicle Routing Problem Solver:</b>'
